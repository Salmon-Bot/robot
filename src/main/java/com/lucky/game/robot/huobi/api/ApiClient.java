...
public class ApiClient {
     ...
     * @return
     */
    public DepthResponse<Depth> depth(DepthRequest request) {
        HashMap map = new HashMap();
     ...
     * @return
     */
    public BatchcancelResponse<Batchcancel<List, BatchcancelBean>> submitcancels(List orderList) {
    ...
    public MatchresultsOrdersDetailResponse<MatchresultsOrdersDetail> matchresults(String orderId) {
        MatchresultsOrdersDetailResponse resp = get("/v1/order/orders/" + orderId + "/matchresults", null, new TypeReference<MatchresultsOrdersDetailResponse<MatchresultsOrdersDetail>>() {
        });
        return resp;
    }

    public IntrustDetailResponse<List<IntrustDetail>> intrustOrdersDetail(Map<String, String> map) {
